    ...
    return (
        ...
        <header className="w-full text-gray-700 bg-white border-gray-100 shadow-sm body-font">
            <div className="container flex flex-col flex-wrap items-center p-5 mx-auto md:flex-row">
                ...
                <a  href="/"
                    className="flex items-center order-first mb-4 font-bold text-gray-900 lg:order-none lg:w-1/5 title-font lg:items-center lg:justify-center md:mb-0">
                    <h1>Flybondi</h1>
                ...
                <div className="inline-flex items-center h-full ml-5 lg:w-2/5 lg:justify-end lg:ml-0">
                    ...
                    <a href="#_"
                        className="px-4 py-2 text-sm font-bold font-sans text-white transition-all duration-150 bg-[#fdbe15] rounded shadow outline-none hover:shadow-md hover:bg-btn-hover ease">
                        Sign Up
                    </a>
                </div>
            </div>
