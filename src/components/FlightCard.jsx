    ...
    return (
        ...
        >
            ...
            <div className="md:w-[260px] bg-gradient-to-b from-gray-50/50 to-gray-50 p-5 md:p-6 border-t md:border-t-0 md:border-l border-gray-100 flex flex-row md:flex-col justify-between items-center md:items-stretch gap-4 shrink-0 relative">
                ...
                <button className="bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white font-semibold py-3 px-6 rounded-xl shadow-md transition-all flex items-center justify-center gap-2 group-hover:shadow-[0_4px_14px_rgba(37,99,235,0.39)] hover:-translate-y-[1px] shrink-0">
