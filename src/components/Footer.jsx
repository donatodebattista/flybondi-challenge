export const Footer = () => {
    ...
    return (
        <footer className="shadow relative bottom-0 bg-[#101010] mt-4 sm:mt-10">
            <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                <div className="sm:flex sm:items-center sm:justify-between">
                    <a href="/" className="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
                        ...
                        <span className="self-center text-2xl font-semibold whitespace-nowrap text-white">Flybondi</span>
                    </a>
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-4 pt-2 pb-4">
                    <span className="text-sm text-gray-500 dark:text-gray-400 text-center">
                        © 2026 Flybondi™ All Rights Reserved.
                    </span>
                    <div className="text-sm text-gray-500 dark:text-gray-400 flex items-center flex-wrap justify-center gap-1.5">
                        <span>Hecho con</span>
                        <span className="text-red-500 px-0.5">❤</span>
                        <span>por</span>
                        <a
                            className="text-gray-300 hover:text-white font-medium transition-colors border-b border-transparent hover:border-white"
